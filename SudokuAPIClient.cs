...
namespace APIVerve
{
    public class SudokuAPIClient
    {
        ...
        public SudokuAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public SudokuAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SudokuQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(SudokuQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(SudokuQueryOptions options)
        {
